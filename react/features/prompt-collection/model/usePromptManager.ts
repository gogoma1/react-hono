...
export function usePromptManager() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            if (storedData) {
                ...
                // Ensure default prompts are always present if missing from storage
    ...
    useEffect(() => {
        // Prevent writing the initial empty array to localStorage
        if (prompts.length > 0) {
            try {
             ...
             // Optional: clean up localStorage if all prompts are deleted
