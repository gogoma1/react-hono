...
const { CLOUDFLARE_ACCOUNT_ID, CLOUDFLARE_D1_DATABASE_LOG_ID, CLOUDFLARE_API_TOKEN } = process.env;
...
console.log("CLOUDFLARE_D1_DATABASE_ID:", CLOUDFLARE_D1_DATABASE_LOG_ID ? '✅ Loaded' : '❌ Not Loaded');
console.log("-------------------------------------------");

export default {
    schema: './api/db/schema.log.d1.ts', // D1용 스키마 경로
    out: './drizzle_d1_log',
    dialect: 'sqlite',
    driver: 'd1-http', // HTTP API를 통해 D1에 연결
    dbCredentials: {
        accountId: CLOUDFLARE_ACCOUNT_ID!,
        databaseId: CLOUDFLARE_D1_DATABASE_LOG_ID!,
